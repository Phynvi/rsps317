...
public class TreasureTrails {
	...
	public TreasureTrails(Player client) {
		this.c = client;
	}

	public int clue1[] = { 1077, 1089, 1107, 1125, 1131, 1129, 1133, 1511, 1168, 1165, 1179, 1195, 1217, 1283, 1297, 1313, 1327, 1341, 1361, 1367, 1426, 2633, 2635, 2637, 7388, 7386, 7392, 7390, 7396, 7394, 2631, 7364, 7362, 7368, 7366, 2583, 2585, 2587, 2589, 2591, 2593, 2595, 2597, 7332, 7338, 7350, 7356, 10404, 10406, 10408, 10410, 10412, 10414, 10424, 10426, 10428, 10430, 10432, 10434, 10458, 10460, 10462, 10464, 10466, 10468 };

	public int clue2[] = { 2599, 2601, 2603, 2605, 2607, 2609, 2611, 2613, 7334, 7340, 7346, 7352, 7358, 7319, 7321, 7323, 7325, 7327, 7372, 7370, 7380, 7378, 2645, 2647, 2649, 2577, 2579, 1073, 1091, 1099, 1111, 1135, 1124, 1145, 1161, 1169, 1183, 1199, 1211, 1245, 1271, 1287, 1301, 1317, 1332, 1357, 1371, 1430, 6916, 6918, 6920, 6922, 6924, 10400, 10402, 10416, 10418, 10420, 10422, 10436, 10438, 10446, 10448, 10450, 10452, 10454, 10456, 6889 };

	public int clue3[] = { 1079, 1093, 1113, 1127, 1147, 1163, 1185, 1201, 1275, 1303, 1319, 1333, 1359, 1373, 2491, 2497, 2503, 861, 859, 2581, 2651, 1079, 1093, 1113, 1127, 1147, 1163, 1185, 1201, 1275, 1303, 1319, 1333, 1359, 1373, 2491, 2497, 2503, 861, 859, 2581, 2651, 2615, 2617, 2619, 2621, 2623, 2625, 2627, 2629, 2639, 2641, 2643, 2651, 2653, 2655, 2657, 2659, 2661, 2663, 2665, 2667, 2669, 2671, 2673, 2675, 2581, 7342, 7348, 7454, 7460, 7374, 7376, 7382, 7384, 7398, 7399, 7400, 3481, 3483, 3485, 3486, 3488, 1079, 1093, 1113, 1127, 1148, 1164, 1185, 1201, 1213, 1247, 1275, 1289, 1303, 1319, 1333, 1347, 1359, 1374, 1432, 2615, 2617, 2619, 2621, 2623, 2625, 2627, 2629, 2639, 2641, 2643, 2651, 2653, 2655, 2657, 2659, 2661, 2663, 2665, 2667, 2669, 2671, 2673, 2675, 2581, 7342, 7348, 7454, 7460, 7374, 7376, 7382, 7384, 7398, 7399, 7400, 3481, 3483, 3485, 3486, 3488, 1079, 1093, 1113, 1127, 1148, 1164, 1185, 1201, 1213, 1247, 1275, 1289, 1303, 1319, 1333, 1347, 1359, 1374, 1432, 10330, 10338, 10348, 10332, 10340, 10346, 10334, 10342, 10350, 10336, 10344, 10352, 10368, 10376, 10384, 10370, 10378, 10386, 10372, 10380, 10388, 10374, 10382, 10390, 10470, 10472, 10474, 10440, 10442, 10444, 6914 };
	...
	public void Hints(int puzzle) {
		...
		case 1:
			for (int i = 2749; i < 2773; i++) {
				c.getPA().sendFrame34(i, v, 6985, 1);
				v += 1;
			}
			c.getPA().sendFrame34(2753, 4, 6985, 1);
			break;
		case 3:
			v = 0;
			...
			c.getPA().sendFrame34(3623, 4, 6985, 1);
			break;
		case 2:
			v = 0;
			...
			c.getPA().sendFrame34(3647, 4, 6985, 1);
			break;
		}
	}
	...
	public void openPuzzle(int puzzle) {
		...
		case 1:
			for (int i = 0; i < 24; i++) {
				...
				if (castlePuzzle[d] != 0) {
					c.getPA().sendFrame34(castlePuzzle[d], v, 6980, 1); // 11126
		...
		case 2:
			for (int i = 0; i < 24; i++) {
				...
				if (trollPuzzle[d] != 0) {
					c.getPA().sendFrame34(trollPuzzle[d], v, 6980, 1); // 11126
		...
		case 3:
			for (int i = 0; i < 24; i++) {
				...
				if (treePuzzle[d] != 0) {
					c.getPA().sendFrame34(treePuzzle[d], v, 6980, 1); // 11126
		...
		c.getPA().sendFrame34(puzzleSlot[4], 4, 6980, 1); // 11126
	}
	...
	public void clearPuzzle() {
		for (int i = 0; i < 25; i++) {
			c.getPA().sendFrame34(-1, i, 6980, 0); // 11126
			puzzleSlot[i] = -1;
		}
		int z = 0;
		switch (puzzleId) {

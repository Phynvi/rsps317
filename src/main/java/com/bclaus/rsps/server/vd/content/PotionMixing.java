...
/**
 * @author Tim ref http://rune-server.org/members/Someone
 */

public class PotionMixing {

	public static void mixPotion2(final Player c, int id, int id2) {
	...
	private static int[][] potMixing = { { 117, 117, 113, 227 }, { 119, 115, 113, 227 }, { 115, 119, 113, 227 }, { 123, 123, 2428, 227 }, { 121, 125, 2428, 227 }, { 125, 121, 2428, 227 }, { 133, 133, 2432, 227 }, { 133, 137, 2432, 227 }, { 137, 133, 2432, 227 }, { 159, 159, 2440, 227 }, { 157, 161, 2440, 227 }, { 161, 157, 2440, 227 }, { 147, 147, 2436, 227 }, { 149, 145, 2436, 227 }, { 145, 149, 2436, 227 }, { 165, 165, 2442, 227 }, { 163, 167, 2442, 227 }, { 167, 163, 2442, 227 }, { 6689, 6689, 6685, 227 }, { 6687, 6691, 2442, 227 }, { 6691, 6687, 2442, 227 }, { 171, 171, 2444, 227 }, { 169, 173, 2444, 227 }, { 173, 169, 2444, 227 }, { 177, 177, 2446, 227 }, { 179, 175, 2446, 227 }, { 175, 179, 2446, 227 }, { 3028, 3028, 3024, 227 }, { 3030, 3026, 3024, 227 }, { 3026, 3030, 3024, 227 }, { 141, 141, 2434, 227 }, { 139, 143, 2434, 227 }, { 143, 139, 2434, 227 }, { 3044, 3044, 3040, 227 }, { 3042, 3046, 3040, 227 }, { 183, 183, 2450, 227 }, { 189, 193, 2450, 227 }, { 193, 189, 2450, 227 }, { 3046, 3042, 3040, 227 }, { 2456, 2456, 2452, 227 }, { 2454, 2458, 2452, 227 }, { 2458, 2454, 2452, 227 } };

	// use id, use id2, new id1, new id2
	public static void mixPotion(Player c, int id, int id2) {
		for (int[] aPotMixing : potMixing) {
			if ((aPotMixing[0] == id && aPotMixing[1] == id) || (aPotMixing[1] == id && aPotMixing[0] == id2)) {
				c.getItems().deleteItem(id, c.getItems().getItemSlot(id), 1);
				c.getItems().deleteItem(id2, c.getItems().getItemSlot(id2), 1);

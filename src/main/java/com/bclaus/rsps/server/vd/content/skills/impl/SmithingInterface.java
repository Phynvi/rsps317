...
public class SmithingInterface {
	...
	public static void showSmithInterface(Player c, int itemId) {
		switch (itemId) {
		case 2349:
	...
	private static void makeRuneInterface(Player c) {
		...
		c.getPA().sendFrame126(threeb + "5 Bars" + threeb, 1115);
	...
	private static void makeAddyInterface(Player c) {
	...
	private static void makeMithInterface(Player c) {
	...
	private static void makeSteelInterface(Player c) {
	...
	private static void makeIronInterface(Player c) {
	...
	private static void makeBronzeInterface(Player c) {
	...
	private static String GetForlvl(int i, Player c) {
		return c.playerLevel[13] >= i ? "@whi@" : "@bla@";

	}

	private static String GetForBars(int i, int j, Player c) {
		return c.getItems().playerHasItem(i, j) ? "@gre@" : "@red@";

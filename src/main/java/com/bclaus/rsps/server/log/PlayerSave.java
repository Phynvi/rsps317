...
import com.bclaus.rsps.server.vd.player.PlayerHandler;
...
public class PlayerSave implements Runnable {
        ...
        private static PlayerSave singleton;
        private static long lastGroupSave;
        private static final int SAVE_TIMER = 250;
       
        public static PlayerSave getSingleton() {
                return singleton;
        }
       
        public static void initialize() {
                singleton = new PlayerSave();
        ...
        public void saveRequests() {
                ...
                for (int id : requests) {
                        if (PlayerHandler.players[id] != null) {
                        	Player c = (Player)PlayerHandler.players[id];
        ...
        private static void saveGame(Player client) {
